...
/*
    @Override
    publi boolean onCreateOptionsMenu(Menu menu) {
    ...
    @Override
    publi boolean onOptionsItemSelected(MenuItem item) {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.member) {
            Intent intent = new Intent(this,coreMember.class);
            startActivity(intent);
